 ...
 * 
 */
@WebServiceClient(name = "ServerInfoService", targetNamespace = "http://server.mon.pie.pl/", wsdlLocation = "http://localhost:8888/ws/server?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERINFOSERVICE_QNAME = new QName("http://server.mon.pie.pl/", "ServerInfoService");
    ...
    public ServerInfo getServerInfoPort() {
        return super.getPort(new QName("http://server.mon.pie.pl/", "ServerInfoPort"), ServerInfo.class);
    }
    ...
    public ServerInfo getServerInfoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.mon.pie.pl/", "ServerInfoPort"), ServerInfo.class, features);
    }
